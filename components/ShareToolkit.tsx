...
const ShareToolkit: React.FC<ShareToolkitProps> = ({ scoutId, scoutName, variant = 'card', onClose, onEmailBlast }) => {
  ...
  const templates = useMemo(() => ({
    whatsapp: {
      ...
      message: `Hey! Check out this free tool — it tells you what level of US college soccer you'd fit into based on your stats. Takes 3 minutes:\n\n${link}\n\nPretty eye-opening. Let me know what you get.`,
    },
    instagram: {
      label: 'Instagram DM',
      icon: Instagram,
      ...
      message: `Hey! Thought you might find this interesting — it's a free AI tool that analyzes your college soccer recruiting chances. Tells you D1/D2/D3/NAIA fit based on your stats:\n\n${link}\n\nTakes a few minutes. Worth checking out`,
    },
    coach: {
      ...
      message: `Hi Coach,\n\nI'm ${scoutName} with Warubi Sports. I work with US college programs and help players find the right opportunity.\n\nI'd love to share a free tool with your players — the ExposureEngine. It analyzes their stats and tells them what level of US college soccer they'd realistically fit into (D1, D2, NAIA, etc). Takes 3 minutes and gives them a personalized action plan.\n\n${link}\n\nFeel free to share it with your squad. If any of your players show strong results, I'd be happy to connect them with programs that match their level.\n\nBest,\n${scoutName}`,
    },
    email: {
      label: 'Email',
      icon: Mail,
      ...
      message: `Hi,\n\nI wanted to share a free tool that might help you or someone you know.\n\nThe ExposureEngine analyzes a player's stats, league level, and academics to show where they'd realistically fit in US college soccer — D1, D2, D3, NAIA, or JUCO. It also gives a 90-day action plan.\n\n${link}\n\nTakes about 3 minutes. If the results look promising, I'd be happy to discuss next steps.\n\nBest,\n${scoutName}`,
    },
    sms: {
      label: 'SMS',
      icon: Smartphone,
      ...
      message: `Free tool that shows your US college soccer level — D1 to JUCO — based on your real stats. 3 min: ${link}`,
    },
    generic: {
      label: 'Copy Link',
      icon: Copy,
